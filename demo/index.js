...
var Button, ButtonGroup, Collaspe, DatePicker, Demo, DropDown, Modal, Notify, Switch, TextArea, TextInput, buildIcon, delIcon, infoIcon, m, msgIcon, s, style, tableView, u;
...
tableView = __webpack_require__(31);
...
Demo = (function() {
  function Demo() {
    ...
    this.demoTableViewColMap = {
      name: '名称',
      age: '年龄',
      salary: '工资'
    };
    this.demoTableViewData = [
      {
        name: 'Joe',
        age: 24,
        salary: 10000
    ...
    this.demoTableViewDoc = new Collaspe({
...
s.tag(s.merge([
  Button.mss, ButtonGroup.mss, DatePicker.mss, Switch.mss, DropDown.mss, Modal.mss, TextInput.mss, TextArea.mss, Collaspe.mss, Notify.mss, tableView.mss, {
    Modal: {
      Button: {
