...
TextArea = __webpack_require__(26);

Collaspe = __webpack_require__(27);

Notify = __webpack_require__(30);
...
Demo = (function() {
  function Demo() {
    ...
    this.demoTextArea2 = new TextArea({
...
(function() {
  ...
  Switch = class Switch {
    constructor({enable = true, onToggle = u.noOp}) { // Boolean // (Boolean) -> a
...
(function() {
  ...
  TextInput = class TextInput {
    constructor({content = '', disabled = false, placeholder = '', onChange = u.noOp, onKeyup = u.noOp, onEnter = u.noOp}) { // String // Boolean // String // (String) -> a | Error // (String) -> a | Error // (String) -> a | Error
      // triggered when user stroke Enter
...
(function() {
  ...
  TextArea = class TextArea {
    constructor({content = '', disabled = false, placeholder = '', onChange = u.noOp, onKeydown = u.noOp, onKeyup = u.noOp, allowTab = false, resize = 'none', rows = 5}) { // String // Boolean // String // (String) -> a | Error // (String) -> a | Error // (String) -> a | Error // Boolean // none | both | horizontal | vertical // Number
      // an easier way to control height instead of inject MSS
      this.onChangeInternal = this.onChangeInternal.bind(this);
      this.onkeyupInternal = this.onkeyupInternal.bind(this);
...
(function() {
  ...
  arrowRight = __webpack_require__(28);

  arrowDown = __webpack_require__(29);

  Collaspe = class Collaspe {
    constructor({
        titleArray: titleArray, // [String]
        widgetArray: widgetArray, // [mithril widget]
        autoCollaspe = false, // Boolean
        expandedIndexArray = [],
...
(function() {
  ...
  Notify = class Notify {
    constructor({duration = 3000, onClick = u.noOp}) { // Int // data -> a
      this.onClickInternal = this.onClickInternal.bind(this);
      this.show = this.show.bind(this);
