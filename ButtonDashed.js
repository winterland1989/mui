...
(function() {
  var BUTTON_HEIGHT_MAP, BUTTON_WIDTH_MAP, ButtonDashed, FONTSIZE_MAP, m, ref, s, style, u,
  ...
  module.exports = ButtonDashed = (function() {
    function ButtonDashed(arg) {
    ...
    ButtonDashed.prototype.onClickInternal = function(e) {
      var data;
      if (!this.disabled) {
    ...
    ButtonDashed.prototype.view = function() {
      var self;
      self = this;
      return m("button.ButtonDashed", {
        style: {
